            ...
            <form id="formNuevoMedicamentoRapid" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label class="label-mini">REGISTRO SANITARIO</label>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="concentracion" class="form-control input-enhanced" placeholder="Ej: 500mg">
                        </div>
                        <div class="col-md-3">
                            <label class="label-mini text-primary fw-bold">CONTENIDO *</label>
                ...
                <div class="modal-footer py-2 bg-light">
                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-primary btn-sm shadow-sm" id="btnGuardarMedRapido">
                        <i class="fas fa-save mr-1"></i> Guardar Medicamento
                    </button>
                </div>
            </form>
        </div>
