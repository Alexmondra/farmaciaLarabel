...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_FILENAME_PREFIX', 'farmacia-'),
         ...
         */
        'verify_backup' => env('BACKUP_VERIFY_ARCHIVE', true),
    ...
    'schedule' => [
        'local_database_at' => env('LOCAL_DATABASE_BACKUP_RUN_AT', '01:30'),
        'run_at' => env('BACKUP_RUN_AT', '02:00'),
        'clean_at' => env('BACKUP_CLEAN_AT', '02:30'),
        'monitor_at' => env('BACKUP_MONITOR_AT', '03:00'),
    ],

    'local_database' => [
        'directory' => storage_path(env('LOCAL_DATABASE_BACKUP_PATH', 'backups/database')),
        'keep_files' => env('LOCAL_DATABASE_BACKUP_KEEP_FILES', 7),
    ],
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                MaximumStorageInMegabytes::class => env('BACKUP_MAX_STORAGE_IN_MB', 10240),
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_weekly_backups_for_weeks' => env('BACKUP_KEEP_WEEKLY_FOR_WEEKS', 12),
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => env('BACKUP_DELETE_OLDEST_WHEN_USING_MORE_MB', 10240),
        ],
