...
class VentasAnuladasDetallesSheet implements FromQuery, WithHeadings, WithMapping, WithChunkReading, ShouldAutoSize, WithTitle, WithStyles
{
    public function __construct(private array $filtros) {}

    public function title(): string
    {
        return 'Detalles Anuladas';
    }
