...
class VentasAnuladasResumenSheet implements FromQuery, WithHeadings, WithMapping, WithChunkReading, ShouldAutoSize, WithTitle, WithStyles
{
    ...
    public function query()
    {
        ...
        $q = Venta::query()
            ->with(['cliente', 'usuario', 'sucursal', 'notasCredito'])
